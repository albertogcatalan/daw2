...
if ($email <> "" and $pass <> "") {
	...
	$sql = $db->prepare('INSERT users SET email = :email, pass = :pass, type = 1');
	$sql->bindValue(':email', $email, PDO::PARAM_STR);
	$sql->bindValue(':pass', $pass, PDO::PARAM_STR);
	$sql->execute();
	
	$sql2 = $db->query('INSERT install SET install = 1');
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" method="post" action="index.php">
        <h2 class="form-signin-heading">Instalación</h2>
        ...
        <button class="btn btn-large btn-primary" type="submit">Instalar</button>
      </form>
      <p><?php echo $error; ?></p>
    </div> <!-- /container -->
